  ...
  <section class="vh-100">
    <div class="container py-5 h-100">
      <div class="row d-flex align-items-center justify-content-center h-100">
        ...
        <!-- <p align="center"><a href="index.php" class="text-warning" style="font-weight:600;text-decoration:none;">Beranda</a></p> -->
        ...
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
          ...
          <p align="center">i don't have any account <a href="/register" class="text-warning" style="font-weight:600;text-decoration:none;">Register Here</a></p>
        </div>
      </div>
    </div>
  </section>
