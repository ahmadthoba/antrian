  ...
  <!-- <footer class="footer mt-auto py-4">
    <div class="container">
      ...
      <!-- <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2021 - <a href="..." target="_blank" class="text-danger text-decoration-none">...</a>. All rights reserved.
      </div>
    </div>
  </footer> -->
    ...
    $(document).ready(function() {
      ...
      var table = $('#tabel-antrian').DataTable({
        ...
        "columns": [{
          ...
          {
            "data": "status",
            "visible": false                // non-aktifkan fitur "status"
          },
          {
            "data": null,
            "orderable": false,
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        var id = data["id"];
        // buat variabel untuk menampilkan data "name"
        // var id = data["name"];
        ...
        // mainkan suara nomor antrian (harus terhubung internet)
        setTimeout(function() {
        ...
        $.ajax({
          ...
          data: { id: id, name: name }    // tentukan data yang dikirim
        });
      });
