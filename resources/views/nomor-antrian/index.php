...
<div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="d-flex align-items-center me-md-auto">
          ...
          <h1 class="h5 pt-2">Ambil Antrian</h1>
        </div>
        <!-- breadcrumbs -->
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body text-center d-grid p-5">
              <div class="border border-success rounded-2 py-2 mb-5">
                <h3 class="pt-4">ANTRIAN SAAT INI</h3>
  ...
  <!-- <footer class="footer mt-auto py-4">
    <div class="container"> -->
      ...
      <!-- <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2021 - <a href="https://www..com/" target="_blank" class="text-danger text-decoration-none">www.indrasatya.com</a>. All rights reserved.
      </div>
    </div>
  </footer> -->
